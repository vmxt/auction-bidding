...
class ApprovedSupplierNotification extends Mailable
{
    ...
    {
        return $this->view('mail.approver.approved-supplier-application')
            ->text('mail.approver.approved-supplier-application_plain')
