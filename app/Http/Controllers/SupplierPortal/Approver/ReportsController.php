...
//		$this->middleware('supplier');
	...
	public function getInitialRegistration() {
		...
		return view('theme.pmc_sms.supplier-portal.pages.approver.reports.pending-supplier', compact('page', 'initial_regs'));
	}
	...
	public function getSISSubmissions() {
		...
		return view('theme.pmc_sms.supplier-portal.pages.approver.reports.sis-for-submission', compact('page', 'sis_submission'));
	...
	public function getForApprovals() {
		...
		return view('theme.pmc_sms.supplier-portal.pages.approver.reports.for-approval', compact('page', 'for_approvals'));
	...
	public function getApprovedSuppliers() {
		...
		return view('theme.pmc_sms.supplier-portal.pages.approver.reports.active-suppliers', compact('page', 'active_suppliers'));
