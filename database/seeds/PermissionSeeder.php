...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        \App\Permission::insert([
            ...
            ['name' => 'Delete/Restore Product Category','module' => 'product_category','description' => 'User can delete and restore product categories','routes' => '["product-categories.destroy","product-categories.destroy_many","product-categories.restore"]','methods' => '["destroy","destroy_many","restore"]','user_id' => '1','is_view_page' => '0'],
            ['name' => 'Change Status of Product Category','module' => 'product_category','description' => 'User can change status of product categories','routes' => '["product-categories.change.status"]','methods' => '["change_status"]','user_id' => '1','is_view_page' => '0'],

            ['name' => 'View Product','module' => 'products','description' => 'User can view product listing and details','routes' => '["products.index","products.show"]','methods' => '["index","show"]','user_id' => '1','is_view_page' => '1'],
            ['name' => 'Create Product','module' => 'products','description' => 'User can create products','routes' => '["products.create","products.store"]','methods' => '["create","store"]','user_id' => '1','is_view_page' => '0'],
            ['name' => 'Edit Product','module' => 'products','description' => 'User can edit products','routes' => '["products.edit","products.update"]','methods' => '["edit","update"]','user_id' => '1','is_view_page' => '0'],
            ['name' => 'Delete/Restore Product','module' => 'products','description' => 'User can delete and restore products','routes' => '["products.destroy","products.destroy_many","products.restore"]','methods' => '["destroy","destroy_many","restore"]','user_id' => '1','is_view_page' => '0'],
            ['name' => 'Change Status of Product','module' => 'products','description' => 'User can change status of products','routes' => '["products.change.status"]','methods' => '["change_status"]','user_id' => '1','is_view_page' => '0']
        ]);
    }
}
