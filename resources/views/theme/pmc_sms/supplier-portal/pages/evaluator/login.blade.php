    ...
    <section id="page-title" class="page-title-nobg">
        <div class="container clearfix">
            ...
            <ol class="breadcrumb">             
                ...
                <li class="breadcrumb-item active" aria-current="page">Evaluator Login</li>                      
            </ol>
        </div>
    </section>
@endif
                    ...
                    <div class="col-lg-6 offset-lg-3">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row {{ $errors->has('email') ? 'has-error' : '' }}">
                                ...
                                <input required type="email" id="email" name="email" class="form-control" value="{{ old('email') }}" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
