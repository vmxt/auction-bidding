...
@section('content')
	...
	<section id="page-title" class="page-title-nobg">
        <div class="container clearfix">
            ...
            <ol class="breadcrumb">             
                ...
                <li class="breadcrumb-item active" aria-current="page">Pending Applicants</li>                      
            </ol>
        </div>
    </section>
                ...
                <div class="filter-buttons mg-b-10">
                    <div class="d-md-flex bd-highlight">
                        <div class="bd-highlight mg-r-10 mg-t-10">
                            <h2>Pending Applications ({{$applicants->count() ?? 0}})</h2>
                        </div>
	                        ...
	                        <table class="table mg-b-0 table-light table-hover table-striped" style="width:100%;">
	                            ...
	                            @forelse($applicants as $applicant)
	                                ...
	                                <tr id="row{{$applicant->id}}" class="row_cb">
	                                    ...
	                                    <td>{{ $applicant->contact_person }} </td>
                                        <td>{{ $applicant->designation }} </td>
                                        <td>{{ $applicant->status }} </td>
                                        <td>
                                                    {{ $applicant->created_at->toFormattedDateString() }} <br> 
    ...
    <div class="modal effect-scale" id="remarkss" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <label> Remarks : </label>
                        <textarea id="remark_field" class="form-control" rows="5"></textarea>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-success" onclick="sendWithRemarks();">Send</button>
...
@section('pagejs')
    ...
    <script type="text/javascript">
        ...
        function showRemarksField(e) {

            $('#remark_field').val("");
            var action = e.text.trim();
            $('#profile').modal('hide');
            $('#remarkss').modal('show');        
        ...
        $(document).on('click', '#one-time', function() {
            if($(this).is(':checked')) {
                ...
                $('#is_one_time').val(null);
            }
        });

        function sendWithRemarks() {

            var remarks = $('#remark_field').val().trim();
