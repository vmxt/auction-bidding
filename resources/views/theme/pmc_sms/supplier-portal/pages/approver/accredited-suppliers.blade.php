	...
	<section id="page-title" class="page-title-nobg">
        <div class="container clearfix">
            ...
            <ol class="breadcrumb">             
                ...
                <li class="breadcrumb-item active" aria-current="page">Accredited Suppliers</li>                      
            </ol>
        </div>
    </section>
                ...
                <div class="filter-buttons mg-b-10">
                    <div class="d-md-flex bd-highlight">
                        <div class="bd-highlight mg-r-10 mg-t-10">
                            <h2>Accredited Suppliers ({{$applicants->count() ?? 0}})</h2>
                        </div>
	                    ...
	                    <div class="table-responsive-lg">
	                        <table class="table mg-b-0 table-light table-hover table-striped" style="width:100%;">
	                            ...
	                            <tr>
	                                ...
	                                <th scope="col" width="15%">Date Established</th>
	                                <th scope="col" width="15%">Date Approved</th>
	                            ...
	                            @forelse($applicants as $applicant)
	                                <tr id="row{{$applicant->supplier_id}}" class="row_cb">
	                                    ...
	                                    <td>
                                            ...
                                            @if($applicant->is_one_time == 1 && $applicant->apply_as_permanent == 0)
                                                &nbsp;&nbsp;
                                                <span class="badge badge-warning mr-2" style="background-color:purple; color: white; font-weight: 900;">ONE TIME SUPPLIER</span>
                                            @elseif($applicant->is_one_time == 1 && $applicant->apply_as_permanent == 1 && $applicant->apply_as_permanent_done == 1)
                                                &nbsp;&nbsp;
	                                    ...
	                                    <td><strong>
                                            @php
                                                ...
                                                $last_step = \App\SupplierModels\ApproverSteps::where('approval_id', $approval->id)
                                                    ->where('status', 'Approved')->orderBy('sequence','DESC')->first();
                                            @endphp 
                                            {{ \Carbon\Carbon::parse($last_step->approved_date)->toFormattedDateString() }}
                                        </strong></td>                                        
                                        <td class="text-left">
