                    ...
                    <div class="wd-100p">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                                ...
                                <input required type="email" id="email" name="email" class="form-control" placeholder="Enter email" value="{{ old('email') }}" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
                        ...
                        <div class="cms-footer mg-t-50">
                            <hr>
                            <p class="tx-gray-500 tx-10">Admin Portal v1.0 • Developed by WebFocus Solutions, Inc. &copy; 2020</p>
                        </div>
                    </div>
                </div><!-- sign-wrapper -->
            </div>
