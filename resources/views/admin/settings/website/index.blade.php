                                ...
                                <div class="form-group {{ $errors->has('company_logo') ? 'has-error' : '' }}">
                                    ...
                                    @if(empty($web->company_logo))
                                        <div id="image_div" style="display:none;">
                                            <img src="" id="img_temp" alt="Company Logo" width="100%">  <br /><br />
                                        </div>
                                    @else
                                        <div>
                                            <img src="{{ asset('storage/public/logos/'.$web->company_logo) }}" id="img_temp" alt="Company Logo" width="100%">  <br /><br />
                                ...
                                <div class="form-group {{ $errors->has('web_favicon') ? 'has-error' : '' }}">
                                    ...
                                    @if(empty($web->website_favicon))
                                        <div id="icon_div" style="display:none;">
                                            <img src="" width="25%" id="icon_temp" alt="Website Favicon">  <br /><br />
                                        </div>
                                    @else
                                        <div>
                                            <img src="{{ asset('storage/public/icons/'.$web->website_favicon) }}" id="icon_temp" alt="Website Favicon" width="25%">  <br /><br />
                                        ...
                                        @forelse($medias as $media)
                                            <div class="form-group input-group input-icon">
                                                ...
                                                <select name="social_media[]"  class="form-control">
                                                    ...
                                                    <option @if($media->name == 'pinterest') selected @endif value="pinterest">Pinterest</option>
