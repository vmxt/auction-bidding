                    ...
                    <div class="table-responsive">
                        <form action="{{ route('role.update', $role->id) }}" method="post">
                            ...
                            <div class="modal-body pd-sm-t-30 pd-sm-b-40 pd-sm-x-30">
                                <div class="row row-sm">
                                    <div class="col-sm">
                                        ...
                                        <input required type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $role->name }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea required class="form-control @error('description') is-invalid @enderror" name="description" rows="2">{{ $role->description }}</textarea>
                            ...
                            <div class="modal-footer pd-x-20 pd-y-15">
                                ...
                                <button type="submit" class="btn btn-primary btn-uppercase">Update Role</button>
                            </div>
                        </form>
                    </div>
                </div><!-- card-body -->
