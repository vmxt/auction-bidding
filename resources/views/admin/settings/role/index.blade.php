                                    ...
                                    <form id="filterForm" class="pd-20">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="showInactive">{{__('common.show_deleted')}}</label>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        @if($role->trashed())
                                            <nav class="nav table-options justify-content-end">
                                                <a class="nav-link" href="{{route('role.restore', $role->id)}}" title="Restore this item"><i data-feather="rotate-ccw"></i></a>
                                            </nav>
                                        @else
                                            <nav class="nav table-options justify-content-end">
                                                <a href="{{ route('role.edit',$role->id) }}" title="Edit Role" class="nav-link"><i data-feather="edit"></i></a>
                                                <a href="#modalDeleteRole" class="nav-link delete_role" title="Delete Role"  data-rid="{{ $role->id }}" data-toggle="modal"><i data-feather="trash"></i></a>
                                            </nav>
                                        @endif
                                    </td>
