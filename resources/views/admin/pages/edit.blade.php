			...
			<div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <select name="module" id="module" class="form-control">
                        <option value="sp" @if($page->module == 'sp') selected @endif>Supplier Portal</option>
                        <option value="cms" @if($page->module == 'cms') selected @endif>CMS Portal</option>
                        <option value="ec" @if($page->module == 'ec') selected @endif>Ecommerce Portal</option>
                    </select>
