...
<table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align" style="color: #7a7676; line-height: 170%; text-align: left; word-wrap: break-word;">
    ...
    <p style="font-size: 14px; line-height: 170%; text-align: center;">
        <span style="font-size: 16px; line-height: 27.2px;"> 
            <a href="{{ route('password.reset', $token) }}?email={{ $user->email }}&user=new" target="_blank" style="padding: 10px 20px; background: #0349fc; color: #fff;text-decoration: none;font-size: 14px; border-radius: 3px; text-align: center;">Activate my account</a>
        </span>
    </p>
...
<p style="font-size: 12px; line-height: 140%;"><span style="font-size: 12px; line-height: 19.6px;">Bayugan 3, Rosario,  <br> Agusan Del Sur Philippines, PH 8504 <br> <strong>Phone</strong>: (082) 235 0045 - Local 3103
