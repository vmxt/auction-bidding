  ...
  <div class="v-text-align" style="color: #7a7676; line-height: 170%; text-align: left; word-wrap: break-word;">
    ...
    <p style="font-size: 14px; line-height: 170%; text-align: left;">
        <span style="font-size: 16px; line-height: 27.2px;"> 
            This is to inform you that your inquiry has been sent to our Admin for action. Please expect a response within 24 hours.
        </span>
    </p>
    ...
    <p style="font-size: 14px; line-height: 170%; text-align: left;">
        <span style="font-size: 16px; line-height: 27.2px;"> 
                ...
                Contact Number: {{ $clientInfo['contact'] }} <br>
