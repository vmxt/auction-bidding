...
CKEDITOR.editorConfig = function(config) {
    ...
    if (window.location.origin.includes('cms4.webfocusprod.wsiph2.com')) {
        prefix = '/cerebro/public/theme/cerebro/';
    } else {
        prefix = '/theme/cerebro/';
    }

    config.contentsCss = [window.location.origin + prefix + 'plugins/font-awesome/css/font-awesome.min.css',
        window.location.origin + prefix + 'plugins/bootstrap/css/bootstrap.min.css',
        window.location.origin + prefix + 'plugins/aos/dist/aos.css',
        window.location.origin + prefix + 'plugins/navik/navik.menu.css',
        window.location.origin + prefix + 'plugins/linearicon/linearicon.css',
        window.location.origin + prefix + 'plugins/jssocials/jssocials.css',
        window.location.origin + prefix + 'plugins/jssocials/jssocials-theme-plain.css',
